...
namespace NESterpiece
{
	...
	{
	public:
		void update_state(StdController &pad);

	private:
		void do_input(StdController &pad, StdControllerButton btn, const InputSource &source, const Uint8 *keyboard);
		void do_keyboard_input(StdController &pad, StdControllerButton btn, SDL_Scancode key, const Uint8 *keyboard);
		void do_controller_button_input(StdController &pad, StdControllerButton btn, const InputSource &controller_btn);
		void do_controller_axis_input(StdController &pad, StdControllerButton btn, const InputSource &controller_btn);
	};
